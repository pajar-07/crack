...
___pajarganz___ = '\x1b[1;92m'
___Pajar___ = '\x1b[1;96m'
# CLEAR
def clear():
	os.system('clear')
# BACK
...
def banner():
	clear()
	wel = '# SELAMAT DATANG DI SC JARR'
	wel2 = mark(wel, style='yellow')
	sol().print(wel2)
	au='AUTHOR    :  Pajar_Ganz              SETATUS   :  Premium\nWHATSAPP  :  +6281572025492'
...
def login_lagi():
	banner()
	vino = '[•] Login Akses Token Lu Tod'
	cetak(nel(vino, title=''))
